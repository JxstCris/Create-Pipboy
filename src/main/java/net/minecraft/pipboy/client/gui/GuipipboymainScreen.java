...
public class GuipipboymainScreen extends AbstractContainerScreen<GuipipboymainMenu> implements PipboyModScreens.ScreenAccessor {
    ...
    private static final ResourceLocation IMAGE_0 = ResourceLocation.parse("pipboy:textures/screens/stat_screen.png");
    private static final ResourceLocation IMAGE_1 = ResourceLocation.parse("pipboy:textures/screens/item_screen.png");
    private static final ResourceLocation IMAGE_2 = ResourceLocation.parse("pipboy:textures/screens/data_screen.png");
        ...
        if (ConditionshowdataProcedure.execute(entity)) {
            ...
            for (int i = 1; i <= 3; i++) {
                ...
                if (isSet) {
                    ...
                    guiGraphics.drawString(this.font, "> P" + i + ": [EMPTY]", this.leftPos + 90, this.topPos + startY, -6710887, false); // Se mantiene en gris
                }
                startY += 22;
            }
        }
    ...
    public void init() {
        ...
        button_empty = new PlainTextButton(this.leftPos + 129, this.topPos + 124, 25, 20, Component.translatable("gui.pipboy.guipipboymain.button_empty"), e -> {
            if (true) {
                PacketDistributor.sendToServer(new GuipipboymainButtonMessage(0, (int) entity.getX(), (int) entity.getY(), (int) entity.getZ()));
        ...
        button_empty1 = new PlainTextButton(this.leftPos + 159, this.topPos + 124, 25, 20, Component.translatable("gui.pipboy.guipipboymain.button_empty1"), e -> {
            if (true) {
                PacketDistributor.sendToServer(new GuipipboymainButtonMessage(1, (int) entity.getX(), (int) entity.getY(), (int) entity.getZ()));
        ...
        button_empty2 = new PlainTextButton(this.leftPos + 190, this.topPos + 124, 25, 20, Component.translatable("gui.pipboy.guipipboymain.button_empty2"), e -> {
            if (true) {
                PacketDistributor.sendToServer(new GuipipboymainButtonMessage(2, (int) entity.getX(), (int) entity.getY(), (int) entity.getZ()));
        ...
        button_sp1 = Button.builder(Component.translatable("gui.pipboy.guipipboymain.button_sp1"), e -> {
            if (ConditionshowdataProcedure.execute(entity)) {
                ...
                PacketDistributor.sendToServer(new GuipipboymainButtonMessage(3, pX, pY, pZ));
        ...
        button_dp1 = Button.builder(Component.translatable("gui.pipboy.guipipboymain.button_dp1"), e -> {
            if (ConditionshowdataProcedure.execute(entity)) {
                ...
                PacketDistributor.sendToServer(new GuipipboymainButtonMessage(4, pX, pY, pZ));
       ...
       this.addWidget(button_dp1);
        ...
        button_sp2 = Button.builder(Component.translatable("gui.pipboy.guipipboymain.button_sp2"), e -> {
            if (ConditionshowdataProcedure.execute(entity)) {
                ...
                PacketDistributor.sendToServer(new GuipipboymainButtonMessage(5, pX, pY, pZ));
        ...
        button_dp2 = Button.builder(Component.translatable("gui.pipboy.guipipboymain.button_dp2"), e -> {
            if (ConditionshowdataProcedure.execute(entity)) {
                ...
                PacketDistributor.sendToServer(new GuipipboymainButtonMessage(6, pX, pY, pZ));
        ...
        button_sp3 = Button.builder(Component.translatable("gui.pipboy.guipipboymain.button_sp3"), e -> {
            if (ConditionshowdataProcedure.execute(entity)) {
                ...
                PacketDistributor.sendToServer(new GuipipboymainButtonMessage(7, pX, pY, pZ));
        ...
        button_dp3 = Button.builder(Component.translatable("gui.pipboy.guipipboymain.button_dp3"), e -> {
            if (ConditionshowdataProcedure.execute(entity)) {
                ...
                PacketDistributor.sendToServer(new GuipipboymainButtonMessage(8, pX, pY, pZ));
